...
const AddCard = (props) => {
    ...
    const initialValues = {
        ...
        VIN: '',
        Color: '',
        NumberOfContractWithKadet: '',
        NumberOfContractWithClient: '',
        Duration: '',
        CardAppeal: '',
        DeactivationDate: '',
        ActionStartDate: '',
        DateOfContractWithClient: '',
        DateOfContractWithKadet: '',
    }
    ...
    const onSubmit = (values, { setSubmitting }) => {
        ...
        .then(res => {
           ...
           history.push(`/panel/cards/${res.id}`)
                    ...
                    <FormStyled>
                        ...
                        <div className="form_line full_name">
                            <FieldGroup>
                                ...
                                <InputStyled required placeholder="Номер" name="name" type="text" />
                            </FieldGroup>
                            <FieldGroup>
                                <label htmlFor="SecondName">Цена карты: </label>
                                <InputStyled required placeholder="Цена" name="surname" type="number" />
                            </FieldGroup>
                        </div>
...
export default connect(null, {notify, clearNotifications})(withRouter(AddCard))